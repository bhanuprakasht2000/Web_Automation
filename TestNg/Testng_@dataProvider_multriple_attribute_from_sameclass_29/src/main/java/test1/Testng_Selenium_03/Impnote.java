...
public class Impnote {
	public static void main(String[] args) {
		...
		System.out.println("==================================");
		System.out.println("We are passing the data from  the same class==>we have 2 sets of data=>1>cred and 2>cred1");
		System.out.println("As per our requirement we will pass the data like cred and cred1 in the program==>	@Test(priority = 1,dataProvider=\"cred1\")\r\n");
