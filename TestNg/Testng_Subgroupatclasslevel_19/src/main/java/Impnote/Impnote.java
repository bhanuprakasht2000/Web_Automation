...
public class Impnote {
  ...
  /*  System.out.println("==================================================================================================");
   ...
   /* System.out.println("Grouping at the class level and we can make use it at the test level or suite level in testng.xml");
    System.out.println("Add @Test(groups={'all'}) above the class containing the test methods"); 
    System.out.println("In the xml file run them as==>"+
    					" <groups>\r\n"
    					+ "<run>\r\n"
    					+ "<include name=\"all\"/>\r\n"
    					+ "</run>\r\n"
    					+ "</groups>");
    System.out.println("Instead of passing the all at the method level we will make iyt at the class level for ref check Register.java along with the testng.xml file");*/

System.out.println("Making the group names as the subgroups in the class to and accessing the same from the textng.xml file ");
System.out.println("Kindly visit the Login class for 	@Test(priority = 1,groups= {\"Windows.Smoke\",\"All\",\"Login\"})\r\n"
		+ " along with the testng.xml file");
System.out.println("groups>\r\n"
		+ "<run>\r\n"
		+ "<include name=\"Windows.*\"></include><include name=\"Ios.Sanity\"></include>\r\n"
		+ "</run>\r\n"
		+ "</groups>");   }
}
