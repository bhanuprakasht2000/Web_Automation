...
//		+"at the suite level in the testng.xml file");
    ...
    System.out.println("Open the test-output folder after executing the program-->open the index.html or emailable-report through the browser to chek the Testng reports");
