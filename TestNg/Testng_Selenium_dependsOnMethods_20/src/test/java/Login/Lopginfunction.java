...
public class Lopginfunction {
	...
	//Priority will be overriden by the dependsOnMehtods
	...
	public void loginwithvalidceredentials() {
		...
		Assert.assertTrue(driver.findElement(By.xpath("//*[.='Account']")).isDisplayed());
	}
	@Test(priority=1,dependsOnMethods = {"loginwithvalidceredentials"})
