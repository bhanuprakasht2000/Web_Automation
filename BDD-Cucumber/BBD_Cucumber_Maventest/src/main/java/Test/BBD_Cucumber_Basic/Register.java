...
public class Register {
	...
	//Datatable
	/*When User has to enter the following the mandatory fields
	|firname 	     |Xyz   	 |
	|surname		 |AA 		 |
	|DOB			 |fifth july |
	|gender          |Male		 |
	|Email or phoneno|1234567	 |
	|password		 |bhanu@1q23 |   */
	@When("User has to enter the following the mandatory fields")
	public  void User_has_to_enter_the_following_the_mandatory_field(DataTable dt) {
		  Map<String,String> map1 = dt.asMap(String.class,String.class);
		  System.out.println("User given the firstname as "+map1.get("firstname"));
		  System.out.println("User given the surname as " +map1.get("surname"));
		  System.out.println("User given the Dob as " +map1.get("DOB"));
		  System.out.println("User given the gender as "+map1.get("gender"));
		  System.out.println("User given the Email or phoneno as "+map1.get("Email or phoneno"));
		  System.out.println("User given the password as " +map1.get("password"));
		  System.err.println("Entered all the required fields");
		  }
