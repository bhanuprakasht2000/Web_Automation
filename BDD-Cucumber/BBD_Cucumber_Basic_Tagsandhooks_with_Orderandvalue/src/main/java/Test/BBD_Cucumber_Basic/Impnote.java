...
public class Impnote {
	public static void main(String[] args) {
		...
		System.out.println("In the hooks we are going to use annotations in the hooks");
		System.out.println("Providing the order for the multiple hooks that has to be start before and end after the step definition \n The before order starts as ascending order0,1,2... and after starts as descending order ...2,1,0 ");
	}
}
